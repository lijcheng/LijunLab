...
- [PAAD_Immune](https://pcm2019.shinyapps.io/PAAD_Immune/) Zhang, Zhuangzhuang#, <b>Lijun Cheng</b>#, Jie Li#, Qi Qiao, Anju Karki, Derek B. Allison, Nuha Shaker et al. "Targeting Plk1 sensitizes pancreatic cancer to immune checkpoint therapy." Cancer Research 82, no. 19 (2022):3532-3548. (#Co-first authors, <b> High Impact Factor of 12.8 </b>) (This study illustrates the PLK1 inhibitor resistance mechanism, which caused immune checkpoint gene activated. Combination drug treatment PDL1 inhibitor and plk1 inhibitor can overcome the ‘rewiring’ to stop pancreatic cancer patients'progression)
...
- <b> How to cite:</b> Cheng L, Karkhanis P, Gokbag B, Liu Y, Li L (2022) DGCyTOF: Deep learning with graphic cluster visualization to predict cell types of single cell mass cytometry data. PLoS Comput Biol 18(4): e1008885. https://doi.org/10.1371/journal.pcbi.1008885
